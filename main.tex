...
compression rate \cite{duda2009}. The key difference
...
Since its invention by \cite{duda2009}, ANS appears not to have gained
...
different variants of ANS in \cite{duda2009} and \cite{duda2015}. A
parallelized implementation based on SIMD instructions can be found in
\cite{giesen2014} and a version which encrypts the message whilst compressing
in \cite{duda2016}.  An extension of ANS to models with latent variables was
developed by \cite{townsend2019}.
